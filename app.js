...
const nilaiManualRoutes = require("./routes/nilaiManualRoutes");
const tugasSiswaRoutes = require("./routes/tugasSiswaRoutes");
const rekapNilaiRoutes = require("./routes/rekapNilaiRoutes");
const tarikDataRfidRoutes = require("./routes/tarikDataRfidRoutes");
const tarikDataFpRoutes = require("./routes/tarikDataFpRoutes");
...
app.use("/nilai-manual", nilaiManualRoutes);
app.use("/tugas-siswa", tugasSiswaRoutes);
app.use("/rekap-nilai", rekapNilaiRoutes);
app.use("/tarikdatarfid", tarikDataRfidRoutes);
app.use("/tarikdatafp", tarikDataFpRoutes);
