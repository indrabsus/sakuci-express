...
router.post('/absenguru', proteksi, requireRole('manajemen', 'admin', 'piket'), createAbsenGuru);
router.put('/absenguru/:id_absen', proteksi, requireRole('manajemen', 'admin', 'piket'), updateAbsenGuru);
